...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BottleManager.Entities.Bottle", b =>
                {
            ...
            modelBuilder.Entity("BottleManager.Entities.Cave", b =>
                {
            ...
            modelBuilder.Entity("BottleManager.Entities.Drawer", b =>
                {
                    b.Property<int>("DrawerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BottleManager.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BottleManager.Entities.Bottle", b =>
                {
                    b.HasOne("BottleManager.Entities.Drawer", "Drawer")
                        .WithMany("Bottles")
                        .HasForeignKey("DrawerId");

                    b.HasOne("BottleManager.Entities.User", "User")
                        .WithMany("Bottles")
            ...
            modelBuilder.Entity("BottleManager.Entities.Drawer", b =>
                {
                    b.HasOne("BottleManager.Entities.Cave", "Cave")
                        .WithMany("Drawers")
